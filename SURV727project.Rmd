...
## Data
Two corpuses of tweets were collected to examine the sentiment of Twitter users regarding the Georgia abortion ban. Using the Twitter API, a total of xxx tweets were collected after a few days of listening. The first corpus was collected for a span of 12 hours starting at 10:00pm EST on November 15, 2022. Given that the abortion ban was overturning on that specific day, this corpus of tweets represented Twitter users' inital reaction to the the overturning. The second corpus was collected for a span of xx hours starting at xx:xx EST on November xx, 2022. This corpus of tweets will represent Twitter users reactions after a couple of days of the news release. 
...
```
The corpuses were then cleaned for later text analysis. This cleaning process included...
